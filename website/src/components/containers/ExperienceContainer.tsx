...
const experiences: Experience[] = [
  {
    ...
    type: "work",
    description: [
      "Maintained microservices and built new features using React, Node.js, and PostgreSQL.",
      "Utilizes GraphQL for API communication between services.",
      "Implemented SGIP report generation layout",
    ],
    technologies: [
      "React",
      "Node.js",
  ...
  },
  {
    ...
    technologies: ["React", "TypeScript", ".NET", "AWS", "MySQL"],
  },
  {
    ...
    technologies: ["React", ".NET Core", "MySQL", "WPF"],
  },
  {
        ...
        <Box sx={{ position: "relative" }}>
          ...
          <Box
            sx={{
              ...
              height: "100%",
              background:
                "linear-gradient(180deg, rgba(149, 128, 255, 0.05) 0%, rgba(149, 128, 255, 0.3) 15%, rgba(149, 128, 255, 0.3) 85%, rgba(149, 128, 255, 0.05) 100%)",
              "&::before": {
                content: '""',
                position: "absolute",
                top: 0,
                ...
                borderRadius: "50%",
                background:
                  "linear-gradient(135deg, rgba(149, 128, 255, 0.8) 0%, rgba(149, 128, 255, 0.4) 100%)",
              ...
              "&::after": {
                ...
                borderRadius: "50%",
                background:
                  "linear-gradient(135deg, rgba(149, 128, 255, 0.4) 0%, rgba(149, 128, 255, 0.8) 100%)",
                boxShadow: "0 0 20px rgba(149, 128, 255, 0.5)",
              },
              zIndex: 0,
            }}
                ...
                <Box
                  sx={{
                    ...
                    "&::before": {
                      ...
                      height: "2px",
                      background:
                        "linear-gradient(90deg, rgba(149, 128, 255, 0.1), rgba(149, 128, 255, 0.3))",
                ...
                >
                  <Card
                    sx={{
                      width: { xs: "100%", md: "45%" },
                      background:
                        "linear-gradient(165deg, rgba(31, 27, 46, 0.4) 0%, rgba(31, 27, 46, 0.7) 100%)",
                      ...
                      "&::before": {
                        ...
                        height: "100%",
                        background:
                          "linear-gradient(90deg, transparent 0%, rgba(149, 128, 255, 0.08) 50%, transparent 100%)",
                      ...
                      "&::after": {
                        ...
                        height: "100%",
                        background:
                          "linear-gradient(180deg, transparent, rgba(149, 128, 255, 0.03), transparent)",
                          ...
                          {exp.type === "work" ? (
                            <Work
                              sx={{
                                color: "primary.main",
                                filter:
                                  "drop-shadow(0 0 8px rgba(149, 128, 255, 0.5))",
                                fontSize: "1.2rem",
                              }}
                            />
                          ) : (
